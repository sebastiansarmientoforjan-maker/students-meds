...
      } else {
        console.error("Ocurrió un error inesperado al guardar la administración.");
      }
    }
  };
...
      } else {
        console.error("Ocurrió un error inesperado al guardar estudiante/medicamentos.");
      }
    }
  };
...
      if (!student) {
        // Reemplazamos alert() con una lógica para manejar el mensaje en el UI
...
      } else {
        console.error("Ocurrió un error inesperado al guardar el medicamento extra.");
      }
    }
  };
